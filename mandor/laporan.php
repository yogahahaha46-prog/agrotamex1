...
<div class="print-only" style="display:none; margin-top: 40px; page-break-inside: avoid;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: flex-start; gap: 20px; font-family: 'Times New Roman', Times, serif; font-size: 0.85rem; color: #000;">
        <div style="width: 220px; text-align: center;">
            <p style="margin-bottom: 55px; margin-top: 0;">Penanggung Jawab Lapangan,</p>
        ...
        <div style="width: 220px; text-align: center;">
            <p style="margin-bottom: 55px; margin-top: 0;">Mengetahui / Disetujui,</p>
            <p style="border-top: 1px solid #000; padding-top: 5px; margin: 0;"><strong>Estate Manager</strong><br>Manajer Operasional Kebun</p>
        </div>
    </div>
</div>
